...
<div class="pane" id="pane-popular">
  ...
  <div style="background:#1a1a18;border-left:3px solid #BA7517;padding:12px 16px;border-radius:4px;margin-bottom:16px">
    <p style="font-size:12px;color:#e6e4dc;line-height:1.7;margin:0">
      <strong style="color:#BA7517">⚠ Beta機能・近日アップデート予定</strong><br>
      現在表示されているランキングは<strong>あなた自身の端末での閲覧履歴のみ</strong>を集計したもので、サイト全体・他のユーザーの閲覧データは含まれていません。<br>
      将来的にはサーバー側で全ユーザーの閲覧データを集計し、本当の意味での「人気記事ランキング」を提供する予定です。<br>
      端末を変えるとランキングはリセットされます。
    </p>
  </div>
  {popular_html}
</div>
